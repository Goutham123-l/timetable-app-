...
async function main() {
  ...
  // Subjects
  const ds = await prisma.subject.create({ data: { name: "Data Structures", code: "23CS4111", type: "THEORY", weeklyHours: 4, credits: 4 } });
  const dm = await prisma.subject.create({ data: { name: "Data Mining", code: "23DP6111", type: "THEORY", weeklyHours: 3, credits: 3 } });
  const ai = await prisma.subject.create({ data: { name: "Artificial Intelligence", code: "23CS5111", type: "THEORY", weeklyHours: 3, credits: 3 } });
  const seLab = await prisma.subject.create({ data: { name: "Software Engineering Lab", code: "23CS4221", type: "LAB", weeklyHours: 2, credits: 1 } });
